...
extension GetItInjectableX on _i1.GetIt {
  ...
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i16.TrackerWatcherCubit>(
        () => _i16.TrackerWatcherCubit(gh<_i11.ITrackerRepository>()));
    gh.factory<_i17.ArticleSearcherCubit>(
        () => _i17.ArticleSearcherCubit(gh<_i7.IArticleRepository>()));
    gh.singleton<_i18.FavArticleActorCubit>(
        _i18.FavArticleActorCubit(gh<_i7.IArticleRepository>()));
    gh.singleton<_i19.FavArticleCubit>(
        _i19.FavArticleCubit(gh<_i7.IArticleRepository>()));
    gh.factory<_i20.ArticleWatcherCubit>(() => _i20.ArticleWatcherCubit(
          gh<_i7.IArticleRepository>(),
          gh<_i19.FavArticleCubit>(),
        ));
    return this;
  }
}

class _$AppInjectableProdModule extends _i21.AppInjectableProdModule {}
